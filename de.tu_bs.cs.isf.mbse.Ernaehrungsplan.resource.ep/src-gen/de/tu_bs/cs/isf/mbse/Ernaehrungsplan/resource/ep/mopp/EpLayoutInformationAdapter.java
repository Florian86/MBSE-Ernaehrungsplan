...
/**
 * <p>
 * A EpLayoutInformationAdapter is used to store layout information that is found
 ...
 * EpLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 * </p>
 */
public class EpLayoutInformationAdapter implements Adapter {
	 ...
	 * reference.
	 */
	private List<de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation> layoutInformations = new ArrayList<de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation>();
	...
	public List<de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation layoutInformation) {
