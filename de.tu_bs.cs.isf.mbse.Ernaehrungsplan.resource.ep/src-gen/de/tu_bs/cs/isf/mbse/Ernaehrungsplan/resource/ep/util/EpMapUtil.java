	...
	public static <K> void putAndMergeKeys(Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof List<?>) {
				...
				List<Object> currentValueAsObjectList = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.util.EpListUtil.copySafelyToObjectList(currentValueAsList);
