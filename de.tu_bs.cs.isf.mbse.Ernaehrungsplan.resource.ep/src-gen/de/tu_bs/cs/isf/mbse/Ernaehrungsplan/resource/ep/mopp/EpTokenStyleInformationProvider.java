...
public class EpTokenStyleInformationProvider {
	...
	public de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTokenStyle getDefaultTokenStyle(String tokenName) {
		if ("Ernaehrungsplan".equals(tokenName)) {
			return new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		...
		if ("QUOTED_34_34".equals(tokenName)) {
			return new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpTokenStyle(new int[] {0x2A, 0x00, 0xFF}, null, false, false, false, false);
		}
		if ("TASK_ITEM".equals(tokenName)) {
			return new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpTokenStyle(new int[] {0x7F, 0x9F, 0xBF}, null, true, false, false, false);
		}
		return null;
	}
