 ...
 * to 4 bytes).
 */
public class EpUnicodeConverter extends de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpInputStreamProcessor {
	 ...
	 */
	public EpUnicodeConverter(InputStream inputStream) {
