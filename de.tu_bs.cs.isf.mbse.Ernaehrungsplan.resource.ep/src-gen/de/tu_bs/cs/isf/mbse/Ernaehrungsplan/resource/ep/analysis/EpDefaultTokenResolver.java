 ...
 * </p>
 */
public class EpDefaultTokenResolver implements de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTokenResolver {
	...
	public void resolve(String lexem, EStructuralFeature feature, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.grammar.EpGrammarInformationProvider.INSTANCE.getKeywords()) {
