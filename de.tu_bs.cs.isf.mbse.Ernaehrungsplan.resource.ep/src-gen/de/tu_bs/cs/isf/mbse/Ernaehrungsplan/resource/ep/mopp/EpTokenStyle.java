...
public class EpTokenStyle implements de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTokenStyle {
	...
	public EpTokenStyle(int[] colorAsRGB, int[] backgroundColorAsRGB, boolean bold, boolean italic, boolean striketrough, boolean underline) {
		super();
	...
	public EpTokenStyle(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTokenStyle styleToCopy) {
	...
	public boolean equals(Object obj) {
		...
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpTokenStyle other = (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpTokenStyle) obj;
