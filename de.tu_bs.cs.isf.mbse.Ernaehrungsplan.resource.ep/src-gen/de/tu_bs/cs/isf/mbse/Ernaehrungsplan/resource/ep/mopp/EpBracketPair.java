 ...
 */
public class EpBracketPair implements de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpBracketPair {
	...
	public EpBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;
