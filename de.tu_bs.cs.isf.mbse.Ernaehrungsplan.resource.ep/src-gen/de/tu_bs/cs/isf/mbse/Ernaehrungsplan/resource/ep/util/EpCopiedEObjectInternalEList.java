...
public class EpCopiedEObjectInternalEList extends de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.util.EpCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public EpCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
