...
public class EpLayoutUtil {
	...
	public void transferLayoutInformationToModel(EObject element) {
		...
		for (Iterator<de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(EObject element) {
		...
		if (layoutReference != null) {
			...
			for (Iterator<EObject> i = list.iterator(); i.hasNext(); ) {
				...
				de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public EObject createLayoutInformationModelElement(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation layoutInformation, EPackage layoutPackage) {
		EFactory factory = layoutPackage.getEFactoryInstance();
		Object object = layoutInformation.getObject(null, false);
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.grammar.EpSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.grammar.EpGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation createLayoutInformation(EObject layoutInformationModelElement) {
		Object object = null;
		...
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.grammar.EpSyntaxElement syntaxElement = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.grammar.EpGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.grammar.EpPlaceholder) {
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.grammar.EpPlaceholder placeholder = (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.grammar.EpPlaceholder) syntaxElement;
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTokenResolver tokenResolver = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTokenResolveResult result = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformationAdapter getLayoutInformationAdapter(EObject element) {
	...
	public void removeLayoutInformationAdapter(EObject element) {
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpLayoutInformationAdapter existingAdapter = getLayoutInformationAdapter(element);
