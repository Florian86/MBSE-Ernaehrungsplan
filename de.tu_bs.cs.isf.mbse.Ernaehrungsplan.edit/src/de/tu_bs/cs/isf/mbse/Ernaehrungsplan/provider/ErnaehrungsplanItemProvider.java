...
/**
 * This is the item provider adapter for a {@link de.tu_bs.cs.isf.mbse.Ernaehrungsplan.Ernaehrungsplan} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ErnaehrungsplanPackage.Literals.ERNAEHRUNGSPLAN__PERSONEN,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ErnaehrungsplanPackage.Literals.ERNAEHRUNGSPLAN__GERICHTE,
				 true,
				 false,
				 true,
				 null,
