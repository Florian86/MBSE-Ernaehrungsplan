...
/**
 * This is the item provider adapter for a {@link de.tu_bs.cs.isf.mbse.Ernaehrungsplan.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ErnaehrungsplanPackage.Literals.PERSON__NAME,
				 true,
				 false,
				 false,
	...
	protected void addKcalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_kcal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_kcal_feature", "_UI_Person_type"),
				 ErnaehrungsplanPackage.Literals.PERSON__KCAL,
				 true,
				 false,
				 false,
