 ...
 */
public class EpHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public EpHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				ep.resource.ep.mopp.EpPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
