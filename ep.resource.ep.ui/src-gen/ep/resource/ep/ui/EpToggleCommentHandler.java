...
public class EpToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof ep.resource.ep.ui.EpEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		ep.resource.ep.ui.EpEditor editor = null;
		
		if (editorPart instanceof ep.resource.ep.ui.EpEditor) {
			editor = (ep.resource.ep.ui.EpEditor) editorPart;
