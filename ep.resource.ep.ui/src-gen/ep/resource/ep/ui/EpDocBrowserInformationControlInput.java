...
public class EpDocBrowserInformationControlInput {
	 ...
	 */
	public EpDocBrowserInformationControlInput(EpDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
