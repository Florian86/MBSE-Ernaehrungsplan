 ...
 * olInput</code>.
 */
public class EpDocBrowserInformationControlInput {
	
	private final EpDocBrowserInformationControlInput fPrevious;
	private EpDocBrowserInformationControlInput fNext;
	 ...
	 */
	public EpDocBrowserInformationControlInput(EpDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public EpDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public EpDocBrowserInformationControlInput getNext() {
		return fNext;
	}
