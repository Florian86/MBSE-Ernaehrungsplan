...
public class EpBracketSet {
	...
	private ArrayList<ep.resource.ep.IEpBracketPair> bracketPairs;
	...
	public EpBracketSet() {
		...
		this.bracketPairs = new ArrayList<ep.resource.ep.IEpBracketPair>();
	}
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new ep.resource.ep.mopp.EpBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<ep.resource.ep.IEpBracketPair>();
