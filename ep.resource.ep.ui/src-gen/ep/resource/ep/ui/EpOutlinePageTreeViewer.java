 ...
 * a specified depth.
 */
public class EpOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public EpOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = ep.resource.ep.util.EpStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof ep.resource.ep.ui.EpEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			ep.resource.ep.mopp.EpPlugin.logError("Exception while refreshing outline view", e);
		}
	}
