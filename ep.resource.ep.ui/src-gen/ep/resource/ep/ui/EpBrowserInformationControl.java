...
public class EpBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof ep.resource.ep.ui.EpDocBrowserInformationControlInput);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = ep.resource.ep.ui.EpHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
