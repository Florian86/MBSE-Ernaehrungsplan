 ...
 */
public class EpNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new ep.resource.ep.mopp.EpMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("ep.resource.ep.ui");
							...
							String natureID = ep.resource.ep.mopp.EpNature.NATURE_ID;
							...
							for (String builderID : ep.resource.ep.mopp.EpNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								ep.resource.ep.mopp.EpMetaInformation info = new ep.resource.ep.mopp.EpMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = ep.resource.ep.ui.EpUIPlugin.getDefault().getBundle();
