...
public class EpNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	 ...
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = ep.resource.ep.ui.EpUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = ep.resource.ep.ui.EpUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = ep.resource.ep.ui.EpUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = ep.resource.ep.ui.EpUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * ep.resource.ep.ui.EpNewProjectWizardLogic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new ep.resource.ep.ui.EpNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), ep.resource.ep.ui.EpUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		IPath path = new Path(ep.resource.ep.ui.EpUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_ICON);
		Bundle bundle = ep.resource.ep.ui.EpUIPlugin.getDefault().getBundle();
		...
		setWindowTitle(ep.resource.ep.ui.EpUIResourceBundle.NEW_PROJECT_WIZARD_WINDOW_TITLE);
	}
