...
public class EpBracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench workbench) {
		...
		bracketsTmp = new ep.resource.ep.ui.EpBracketSet();
	...
	private void handleMatchingBracketsSelection() {
		...
		initializeLanguage();
		bracketsTmp.deserialize(getPreferenceStore().getString(language + ep.resource.ep.ui.EpPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				ep.resource.ep.IEpBracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected void performDefaults() {
		...
		enableCheckbox.setSelection(preferenceStore.getDefaultBoolean(ep.resource.ep.ui.EpPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		matchingBracketsColorEditor.setColorValue(PreferenceConverter.getDefaultColor(preferenceStore, BRACKETS_COLOR));
		String defaultBrackets = preferenceStore.getDefaultString(language + ep.resource.ep.ui.EpPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	private void updateActiveEditor() {
		...
		preferenceStore.setValue(ep.resource.ep.ui.EpPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		preferenceStore.setValue(language + ep.resource.ep.ui.EpPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
	...
	protected ep.resource.ep.IEpBracketPair getSelectedBracketPair() {
