...
public class EpLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(ep.resource.ep.mopp.EpPlugin.DEBUG_MODEL_ID);
			...
			ep.resource.ep.debug.EpLineBreakpoint lineBreakpoint = new ep.resource.ep.debug.EpLineBreakpoint(resource, lineNumber + 1);
