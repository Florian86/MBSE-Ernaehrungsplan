...
public class EpAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof ep.resource.ep.debug.EpDebugVariable) {
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof ep.resource.ep.debug.EpDebugVariable) {
			final ep.resource.ep.debug.EpDebugVariable variable = (ep.resource.ep.debug.EpDebugVariable) adaptableObject;
