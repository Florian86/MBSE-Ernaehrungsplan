 ...
 */
public class EpSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public EpSyntaxColoringPreferencePage() {
		...
		ep.resource.ep.mopp.EpMetaInformation metaInformation = new ep.resource.ep.mopp.EpMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = ep.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ep.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = ep.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ep.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = ep.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ep.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = ep.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ep.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = ep.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ep.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = ep.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, ep.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		ep.resource.ep.ui.EpPixelConverter pixelConverter = new ep.resource.ep.ui.EpPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof ep.resource.ep.ui.EpEditor) {
			ep.resource.ep.ui.EpEditor emfTextEditor = (ep.resource.ep.ui.EpEditor) editor;
