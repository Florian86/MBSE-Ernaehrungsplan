...
public class EpOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	...
	public void createControl(Composite parent) {
		treeViewer = new ep.resource.ep.ui.EpOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof ep.resource.ep.ui.EpOutlinePageTreeViewer) {
								ep.resource.ep.ui.EpOutlinePageTreeViewer pageTreeViewer = (ep.resource.ep.ui.EpOutlinePageTreeViewer) viewer;
	...
	private void createActions() {
		...
		List<IAction> actions = new ep.resource.ep.ui.EpOutlinePageActionProvider().getActions(treeViewer);
