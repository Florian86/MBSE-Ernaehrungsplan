 ...
 */
public class EpNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public EpNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new ep file");
