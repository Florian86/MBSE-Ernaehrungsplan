 ...
 */
public class EpCompletionProposal implements java.lang.Comparable<EpCompletionProposal> {
	 ...
	 */
	private ep.resource.ep.mopp.EpExpectedTerminal expectedTerminal;
	...
	public EpCompletionProposal(ep.resource.ep.mopp.EpExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public EpCompletionProposal(ep.resource.ep.mopp.EpExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public EpCompletionProposal(ep.resource.ep.mopp.EpExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public ep.resource.ep.mopp.EpExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof EpCompletionProposal) {
			EpCompletionProposal other = (EpCompletionProposal) object;
	...
	public int compareTo(EpCompletionProposal object) {
		if (object instanceof EpCompletionProposal) {
			EpCompletionProposal other = (EpCompletionProposal) object;
