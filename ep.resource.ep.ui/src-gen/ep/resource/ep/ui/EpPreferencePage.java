 ...
 */
public class EpPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(ep.resource.ep.ui.EpUIPlugin.getDefault().getPreferenceStore());
		setDescription("Ep Text Editor Preferences");
	}
