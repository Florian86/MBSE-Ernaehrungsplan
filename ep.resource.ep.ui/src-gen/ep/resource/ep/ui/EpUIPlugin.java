 ...
 */
public class EpUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "ep.resource.ep.ui";
	public static final String EDITOR_ID = "ep.resource.ep.ui.EpEditor";
	...
	private static EpUIPlugin plugin;
	...
	public static EpUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EpUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EpUIPlugin.PLUGIN_ID, message);
		}
		final EpUIPlugin pluginInstance = EpUIPlugin.getDefault();
