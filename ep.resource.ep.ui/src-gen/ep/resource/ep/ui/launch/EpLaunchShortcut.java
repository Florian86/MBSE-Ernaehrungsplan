 ...
 */
public class EpLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new ep.resource.ep.mopp.EpMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(ep.resource.ep.launch.EpLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			ep.resource.ep.mopp.EpPlugin.logError("Exception while launching selection", e);
		}
	}
