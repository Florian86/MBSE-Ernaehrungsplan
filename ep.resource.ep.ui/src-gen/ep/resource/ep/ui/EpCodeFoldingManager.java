...
public class EpCodeFoldingManager {
	...
	private class FoldingUpdateListener implements ep.resource.ep.IEpBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(ep.resource.ep.ui.EpEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof ep.resource.ep.ui.EpEditor) {
				ep.resource.ep.ui.EpEditor editor = (ep.resource.ep.ui.EpEditor) workbenchPart;
	...
	protected ep.resource.ep.ui.EpEditor editor;
	 ...
	 */
	public EpCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,ep.resource.ep.ui.EpEditor textEditor) {
	...
	private void addCloseListener(final ep.resource.ep.ui.EpEditor editor) {
	...
	private java.io.File getCodeFoldingStateFile(String uriString) {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(ep.resource.ep.ui.EpUIPlugin.PLUGIN_ID);
	...
	private String makeMD5(String text) {
		...
		try {
			...
			ep.resource.ep.ui.EpUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		ep.resource.ep.IEpTextResource textResource = (ep.resource.ep.IEpTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
