...
public class EpANTLRTextToken extends ep.resource.ep.mopp.EpTextToken {
	
	private final static ep.resource.ep.IEpMetaInformation metaInformation = new ep.resource.ep.mopp.EpMetaInformation();
	
	public EpANTLRTextToken(org.antlr.runtime3_4_0.Token antlrToken) {
