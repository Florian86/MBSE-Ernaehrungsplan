...
public class EpExpectedTerminal {
	...
	public EpExpectedTerminal(EObject container, ep.resource.ep.IEpExpectedElement terminal, int followSetID, ep.resource.ep.grammar.EpContainmentTrace containmentTrace) {
		super();
