...
public class EpExpectedTerminal {
	...
	private ep.resource.ep.IEpExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private ep.resource.ep.grammar.EpContainmentTrace containmentTrace;
	
	public EpExpectedTerminal(org.eclipse.emf.ecore.EObject container, ep.resource.ep.IEpExpectedElement terminal, int followSetID, ep.resource.ep.grammar.EpContainmentTrace containmentTrace) {
		super();
	...
	public ep.resource.ep.IEpExpectedElement getTerminal() {
		return terminal;
	}
	...
	public ep.resource.ep.grammar.EpContainmentTrace getContainmentTrace() {
