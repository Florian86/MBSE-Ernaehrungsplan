 ...
 */
public class EpPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "ep.resource.ep";
	/**
	...
	public static EpPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, EpPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, EpPlugin.PLUGIN_ID, message);
		}
		final EpPlugin pluginInstance = EpPlugin.getDefault();
