...
public class EpLayoutInformation {
	 ...
	 */
	private final ep.resource.ep.grammar.EpSyntaxElement syntaxElement;
	...
	public EpLayoutInformation(ep.resource.ep.grammar.EpSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public ep.resource.ep.grammar.EpSyntaxElement getSyntaxElement() {
