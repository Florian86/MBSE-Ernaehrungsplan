...
public class EpNewFileContentProvider {
	...
	protected String getExampleContent(EClass eClass, EClass[] allClassesWithSyntax, String newFileName) {
		...
		EObject root = new ep.resource.ep.util.EpMinimalModelHelper().getMinimalModel(eClass, allClassesWithSyntax, newFileName);
		if (root == null) {
	...
	public ep.resource.ep.IEpTextPrinter getPrinter(OutputStream outputStream) {
