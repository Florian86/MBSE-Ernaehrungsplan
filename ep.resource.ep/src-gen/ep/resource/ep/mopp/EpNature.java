...
public class EpNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "ep.resource.ep.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {ep.resource.ep.mopp.EpBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(ep.resource.ep.mopp.EpBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
