 ...
 */
public class EpEnumerationTerminal extends ep.resource.ep.grammar.EpTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public EpEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, ep.resource.ep.grammar.EpCardinality cardinality, int mandatoryOccurrencesAfter) {
