...
public interface IEpOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new ep.resource.ep.mopp.EpMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new ep.resource.ep.mopp.EpMetaInformation().getResourcePostProcessorProviderOptionKey();
