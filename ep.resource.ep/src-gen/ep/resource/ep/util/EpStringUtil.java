...
public class EpStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, ep.resource.ep.IEpFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, ep.resource.ep.IEpFunction1<String, T> toStringFunction) {
