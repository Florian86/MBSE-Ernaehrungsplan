 ...
 * resolver
 */
public interface IEpReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends ep.resource.ep.IEpConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, ep.resource.ep.IEpReferenceResolveResult<ReferenceType> result);
