 ...
 * given name.
 */
public class EpReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements ep.resource.ep.IEpReferenceCache {
	...
	private ep.resource.ep.IEpNameProvider nameProvider;
	
	public EpReferenceCache(ep.resource.ep.IEpNameProvider nameProvider) {
		super();
