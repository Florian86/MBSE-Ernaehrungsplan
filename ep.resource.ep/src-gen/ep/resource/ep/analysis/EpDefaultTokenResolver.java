...
public class EpDefaultTokenResolver implements ep.resource.ep.IEpTokenResolver {
	...
	public void resolve(String lexem, EStructuralFeature feature, ep.resource.ep.IEpTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, EStructuralFeature feature, ep.resource.ep.IEpTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
