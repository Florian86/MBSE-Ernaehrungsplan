 ...
 */
public class EpDefaultTokenResolver implements ep.resource.ep.IEpTokenResolver {
	 ...
	 */
	public EpDefaultTokenResolver(boolean escapeKeywords) {
		super();
		this.escapeKeywords = escapeKeywords;
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, ep.resource.ep.IEpTokenResolveResult result) {
		resolve(lexem, feature, result, null, null, null);
	}
	
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, ep.resource.ep.IEpTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : ep.resource.ep.grammar.EpGrammarInformationProvider.INSTANCE.getKeywords()) {
