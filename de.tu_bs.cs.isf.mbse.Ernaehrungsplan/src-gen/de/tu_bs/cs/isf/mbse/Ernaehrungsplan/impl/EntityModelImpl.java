 ...
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.mbse.Ernaehrungsplan.impl.EntityModelImpl#getTypes <em>Types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntityModelImpl extends EObjectImpl implements EntityModel {
	...
	protected EClass eStaticClass() {
		return ErnaehrungsplanPackage.Literals.ENTITY_MODEL;
	}
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, ErnaehrungsplanPackage.ENTITY_MODEL__TYPES);
		}
		return types;
	}
