 ...
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.mbse.Ernaehrungsplan.impl.EpElementImpl#getEplanElement <em>Eplan Element</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.mbse.Ernaehrungsplan.impl.EpElementImpl#getPersonElement <em>Person Element</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.mbse.Ernaehrungsplan.impl.EpElementImpl#getZutatElement <em>Zutat Element</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.mbse.Ernaehrungsplan.impl.EpElementImpl#getGerichtElement <em>Gericht Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EpElementImpl extends EObjectImpl implements EpElement {
	...
	protected EClass eStaticClass() {
		return ErnaehrungsplanPackage.Literals.EP_ELEMENT;
	}
	...
	public EList<Ernaehrungsplan> getEplanElement() {
		if (eplanElement == null) {
			eplanElement = new EObjectContainmentEList<Ernaehrungsplan>(Ernaehrungsplan.class, this, ErnaehrungsplanPackage.EP_ELEMENT__EPLAN_ELEMENT);
		}
		return eplanElement;
	}
	...
	public EList<Person> getPersonElement() {
		if (personElement == null) {
			personElement = new EObjectContainmentEList<Person>(Person.class, this, ErnaehrungsplanPackage.EP_ELEMENT__PERSON_ELEMENT);
		}
	...
	public EList<Zutat> getZutatElement() {
		if (zutatElement == null) {
			zutatElement = new EObjectContainmentEList<Zutat>(Zutat.class, this, ErnaehrungsplanPackage.EP_ELEMENT__ZUTAT_ELEMENT);
		}
		return zutatElement;
	}
	...
	public EList<Gericht> getGerichtElement() {
		if (gerichtElement == null) {
			gerichtElement = new EObjectContainmentEList<Gericht>(Gericht.class, this, ErnaehrungsplanPackage.EP_ELEMENT__GERICHT_ELEMENT);
		}
