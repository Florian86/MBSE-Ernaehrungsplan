...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>Ernaehrungsplan</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ErnaehrungsplanExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ErnaehrungsplanPackage.eNS_URI, 
			 ErnaehrungsplanPackage.eINSTANCE);
