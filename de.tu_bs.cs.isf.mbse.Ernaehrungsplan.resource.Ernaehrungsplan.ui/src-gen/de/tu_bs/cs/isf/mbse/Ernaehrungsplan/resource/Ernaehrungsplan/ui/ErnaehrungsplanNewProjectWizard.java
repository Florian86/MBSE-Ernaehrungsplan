 ...
 * </p>
 */
public class ErnaehrungsplanNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		IPath path = new Path(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_ICON);
		Bundle bundle = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanUIPlugin.getDefault().getBundle();
		...
		setWindowTitle(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanUIResourceBundle.NEW_PROJECT_WIZARD_WINDOW_TITLE);
	}
