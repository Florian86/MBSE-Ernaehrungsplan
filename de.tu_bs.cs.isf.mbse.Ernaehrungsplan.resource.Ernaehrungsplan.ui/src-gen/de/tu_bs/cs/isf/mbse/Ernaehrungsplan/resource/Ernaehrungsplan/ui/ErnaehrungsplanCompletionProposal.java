 ...
 */
public class ErnaehrungsplanCompletionProposal implements Comparable<ErnaehrungsplanCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanExpectedTerminal expectedTerminal;
	...
	public ErnaehrungsplanCompletionProposal(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public ErnaehrungsplanCompletionProposal(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public ErnaehrungsplanCompletionProposal(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof ErnaehrungsplanCompletionProposal) {
			ErnaehrungsplanCompletionProposal other = (ErnaehrungsplanCompletionProposal) object;
	...
	public int compareTo(ErnaehrungsplanCompletionProposal object) {
		if (object instanceof ErnaehrungsplanCompletionProposal) {
			ErnaehrungsplanCompletionProposal other = (ErnaehrungsplanCompletionProposal) object;
