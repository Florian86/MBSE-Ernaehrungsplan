...
/**
 * The ErnaehrungsplanAutoEditStrategy extends the default auto edit strategy such
 ...
 */
public class ErnaehrungsplanAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanBracketSet bracketSet;
	
	public ErnaehrungsplanAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanBracketSet bracketSet) {
