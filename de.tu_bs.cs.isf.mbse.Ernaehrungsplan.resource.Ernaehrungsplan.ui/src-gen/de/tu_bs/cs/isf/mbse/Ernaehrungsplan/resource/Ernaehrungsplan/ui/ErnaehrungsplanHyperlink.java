 ...
 */
public class ErnaehrungsplanHyperlink implements IHyperlink {
	 ...
	 */
	public ErnaehrungsplanHyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
