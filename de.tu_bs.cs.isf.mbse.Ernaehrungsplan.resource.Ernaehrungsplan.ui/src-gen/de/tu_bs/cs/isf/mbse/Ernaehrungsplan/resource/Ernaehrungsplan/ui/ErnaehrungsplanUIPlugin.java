 ...
 */
public class ErnaehrungsplanUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui";
	public static final String EDITOR_ID = "de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanEditor";
	...
	private static ErnaehrungsplanUIPlugin plugin;
	
	public ErnaehrungsplanUIPlugin() {
		super();
	}
	...
	public static ErnaehrungsplanUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, ErnaehrungsplanUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, ErnaehrungsplanUIPlugin.PLUGIN_ID, message);
		}
		final ErnaehrungsplanUIPlugin pluginInstance = ErnaehrungsplanUIPlugin.getDefault();
