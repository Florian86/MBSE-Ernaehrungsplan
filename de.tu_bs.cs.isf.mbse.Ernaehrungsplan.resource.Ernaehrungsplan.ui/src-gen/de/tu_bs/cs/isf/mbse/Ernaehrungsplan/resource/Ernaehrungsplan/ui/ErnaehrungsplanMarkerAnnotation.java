...
public class ErnaehrungsplanMarkerAnnotation extends MarkerAnnotation implements IQuickFixableAnnotation {
	
	// private boolean isQuickFixable;
	
	public ErnaehrungsplanMarkerAnnotation(IMarker marker) {
		super(marker);
	}
