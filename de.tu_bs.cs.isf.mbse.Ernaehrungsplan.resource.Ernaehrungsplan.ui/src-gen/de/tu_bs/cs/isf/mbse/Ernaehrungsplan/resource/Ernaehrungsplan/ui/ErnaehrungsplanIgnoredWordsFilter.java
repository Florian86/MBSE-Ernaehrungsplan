 ...
 */
public class ErnaehrungsplanIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.grammar.ErnaehrungsplanGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
