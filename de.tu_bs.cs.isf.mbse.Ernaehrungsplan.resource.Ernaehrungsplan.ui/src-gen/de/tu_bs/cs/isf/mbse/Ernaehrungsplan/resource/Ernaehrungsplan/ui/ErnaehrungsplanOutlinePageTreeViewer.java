 ...
 * a specified depth.
 */
public class ErnaehrungsplanOutlinePageTreeViewer extends TreeViewer {
	...
	public ErnaehrungsplanOutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.ui.ErnaehrungsplanEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanPlugin.logError("Exception while refreshing outline view", e);
		}
	}
