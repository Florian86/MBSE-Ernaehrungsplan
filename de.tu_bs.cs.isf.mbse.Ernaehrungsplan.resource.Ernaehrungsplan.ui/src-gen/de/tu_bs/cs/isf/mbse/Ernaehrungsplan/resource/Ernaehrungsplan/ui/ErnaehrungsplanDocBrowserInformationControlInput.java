 ...
 * olInput</code>.
 */
public class ErnaehrungsplanDocBrowserInformationControlInput {
	
	private final ErnaehrungsplanDocBrowserInformationControlInput fPrevious;
	private ErnaehrungsplanDocBrowserInformationControlInput fNext;
	 ...
	 */
	public ErnaehrungsplanDocBrowserInformationControlInput(ErnaehrungsplanDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public ErnaehrungsplanDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public ErnaehrungsplanDocBrowserInformationControlInput getNext() {
		return fNext;
	}
