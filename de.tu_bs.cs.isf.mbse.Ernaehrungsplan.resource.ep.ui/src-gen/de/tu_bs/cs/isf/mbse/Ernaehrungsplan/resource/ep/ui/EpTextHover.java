 ...
 */
public class EpTextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	
	private static final String FONT = JFaceResources.DIALOG_FONT;
	
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpResourceProvider resourceProvider;
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput infoInput = (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpHyperlink hyperlink = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			if (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBrowserInformationControl.isAvailable(parent)) {
				ToolBarManager tbm = new ToolBarManager(SWT.FLAT);
				de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBrowserInformationControl iControl = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBrowserInformationControl(parent, FONT, tbm);
				...
				IInputChangedListener inputChangeListener = new IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput) {
							de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput input = (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			...
			if (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBrowserInformationControl.isAvailable(parent)) {
				de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBrowserInformationControl iControl = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public EpTextHover(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpHTMLPrinter.insertPageProlog(buffer, 0, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpTextHover.getStyleSheet());
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpHTMLPrinter.addPageEpilog(buffer);
			return new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpUIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.util.EpStreamUtil.getContent(styleSheetURL.openStream());
