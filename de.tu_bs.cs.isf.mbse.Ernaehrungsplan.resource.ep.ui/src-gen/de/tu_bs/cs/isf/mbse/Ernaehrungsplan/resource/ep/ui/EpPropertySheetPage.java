...
public class EpPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEObjectSelection) {
			final de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEObjectSelection selection = (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEObjectSelection) iSelection;
