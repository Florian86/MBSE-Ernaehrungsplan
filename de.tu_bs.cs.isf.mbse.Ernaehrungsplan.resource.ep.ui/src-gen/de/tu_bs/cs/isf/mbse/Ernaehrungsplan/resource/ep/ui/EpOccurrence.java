 ...
 */
public class EpOccurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.IEpTokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.occurences.declaration";
	
	private final static de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionHelper positionHelper = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionHelper();
	 ...
	 */
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTextResource textResource;
	...
	/**
	 * <p>
	 * Creates a EpOccurrence object to find positions to highlight.
	 * </p>
	 * 
	 * @param textResource the text resource for location
	 * @param projectionViewer the viewer for the text
	 */
	public EpOccurrence(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpLocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.IEpTokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected void addAnnotationsForReferences(EObject referencedElement, List<String> matchingNames) {
		...
		for (Setting setting : referencingObjects) {
			...
			for (String name : matchingNames) {
				...
				if (index > 0) {
					addAnnotation(document, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionCategory.PROXY, name, index, name.length());
				}
			}
		}
	}
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.analysis.EpDefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.IEpTokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.IEpTokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.IEpTokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpLocationMap locationMap = textResource.getLocationMap();
		
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.IEpTokenScanner tokenScanner = createTokenScanner();
	...
	protected de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.IEpTokenScanner createTokenScanner() {
		return new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpUIMetaInformation().createTokenScanner(null, null);
	}
	
	protected void addAnnotation(IDocument document, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionCategory type, String text, int offset, int length) {
		...
		if (type == de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionCategory.DEFINITION) {
	...
	protected void removeAnnotations() {
		removeAnnotations(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpOccurrence.DECLARATION_ANNOTATION_ID);
	}
