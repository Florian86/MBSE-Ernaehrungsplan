...
/**
 * The EpAutoEditStrategy extends the default auto edit strategy such that an
 ...
 */
public class EpAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBracketSet bracketSet;
	
	public EpAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBracketSet bracketSet) {
