 ...
 * a specified depth.
 */
public class EpOutlinePageTreeViewer extends TreeViewer {
	...
	public EpOutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpPlugin.logError("Exception while refreshing outline view", e);
		}
	}
