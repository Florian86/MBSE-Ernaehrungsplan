 ...
 */
public class EpHyperlink implements IHyperlink {
	 ...
	 */
	public EpHyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
