 ...
 * </p>
 */
public class EpSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public EpSyntaxColoringPreferencePage() {
		super();
		
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpMetaInformation metaInformation = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPixelConverter pixelConverter = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEditor) {
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEditor emfTextEditor = (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEditor) editor;
