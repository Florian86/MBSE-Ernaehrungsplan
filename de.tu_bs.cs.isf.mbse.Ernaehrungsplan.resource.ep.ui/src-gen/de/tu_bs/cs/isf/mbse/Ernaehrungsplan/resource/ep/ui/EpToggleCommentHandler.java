...
public class EpToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEditor editor = null;
		
		if (editorPart instanceof de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEditor) {
			editor = (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEditor) editorPart;
