...
public class EpOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpNameProvider nameProvider = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.mopp.EpMetaInformation().createNameProvider();
