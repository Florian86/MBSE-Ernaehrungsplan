 ...
 */
public class EpHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpOccurrence occurrence;
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpBackgroundParsingListener {
	 ...
	 */
	public EpHighlighting(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.IEpTextResource textResource, ProjectionViewer projectionViewer, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpColorManager colorManager, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpOccurrence(textResource, projectionViewer);
		this.bracketSet = new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		this.black = colorManager.getColor(new RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEditor editor) {
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
