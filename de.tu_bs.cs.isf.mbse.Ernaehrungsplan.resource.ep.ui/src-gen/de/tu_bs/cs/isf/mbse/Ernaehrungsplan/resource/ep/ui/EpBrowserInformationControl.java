 ...
 * @since 3.2
 */
public class EpBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput fInput;
	 ...
	 */
	public EpBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public EpBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public EpBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput);
		...
		fInput= (de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput) input;
		...
		de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpHTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.ep.ui.EpDocBrowserInformationControlInput getInput() {
		return fInput;
	}
