...
/**
 * <p>
 * ErnaehrungsplanLayoutInformation objects are used to store layout information
 ...
 * </p>
 * <p>
 * ErnaehrungsplanLayoutInformations are aggregated in LayoutInformationAdapters.
 * One ErnaehrungsplanLayoutInformation contains the layout that was found before
 * a keyword, attribute or reference.
 * </p>
 */
public class ErnaehrungsplanLayoutInformation {
	 ...
	 */
	private final de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.grammar.ErnaehrungsplanSyntaxElement syntaxElement;
	...
	public ErnaehrungsplanLayoutInformation(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.grammar.ErnaehrungsplanSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.grammar.ErnaehrungsplanSyntaxElement getSyntaxElement() {
