 ...
 */
public class ErnaehrungsplanEnumerationTerminal extends de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.grammar.ErnaehrungsplanTerminal {
	
	private Map<String, String> mapping = new LinkedHashMap<String, String>();
	
	public ErnaehrungsplanEnumerationTerminal(EStructuralFeature attribute, String[] literalMappings, de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.grammar.ErnaehrungsplanCardinality cardinality, int mandatoryOccurrencesAfter) {
