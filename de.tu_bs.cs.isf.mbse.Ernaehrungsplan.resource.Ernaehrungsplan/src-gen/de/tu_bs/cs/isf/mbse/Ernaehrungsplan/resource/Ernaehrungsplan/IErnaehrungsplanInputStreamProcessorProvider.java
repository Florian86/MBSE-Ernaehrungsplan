 ...
 * conversion.
 */
public interface IErnaehrungsplanInputStreamProcessorProvider {
	 ...
	 */
	public de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanInputStreamProcessor getInputStreamProcessor(InputStream inputStream);
}
