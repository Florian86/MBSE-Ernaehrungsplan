 ...
 */
public class ErnaehrungsplanLaunchConfigurationDelegate extends LaunchConfigurationDelegate {
	...
	public void launch(ILaunchConfiguration configuration, String mode, ILaunch launch, IProgressMonitor monitor) throws CoreException {
		...
		new de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.launch.ErnaehrungsplanLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
