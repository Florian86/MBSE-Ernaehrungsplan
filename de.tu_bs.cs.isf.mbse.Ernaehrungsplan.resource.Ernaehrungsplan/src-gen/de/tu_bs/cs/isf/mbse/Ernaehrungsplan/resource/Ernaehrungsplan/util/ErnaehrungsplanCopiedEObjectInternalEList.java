...
public class ErnaehrungsplanCopiedEObjectInternalEList extends de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.util.ErnaehrungsplanCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public ErnaehrungsplanCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
