...
public class ErnaehrungsplanNature implements IProjectNature {
	
	public static final String NATURE_ID = "de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
