 ...
 * to 4 bytes).
 */
public class ErnaehrungsplanUnicodeConverter extends de.tu_bs.cs.isf.mbse.Ernaehrungsplan.resource.Ernaehrungsplan.mopp.ErnaehrungsplanInputStreamProcessor {
	 ...
	 */
	public ErnaehrungsplanUnicodeConverter(InputStream inputStream) {
